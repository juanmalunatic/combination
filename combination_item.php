...
class Combination_Item
{
    ...
    public $category_taxonomy_id;
    public $category_term_id;

    public $collection_taxonomy_id;
    public $collection_term_id;

    public $model_taxonomy_id;
    public $model_term_id;

    public $variant_taxonomy_id;
    public $variant_term_id;

    public $finish_taxonomy_id;
    public $finish_term_id;

    public $color_taxonomy_id;
    ...
    public function hydrate($data) {
        ...
        $this->category_taxonomy_id = $category_term ? intval($category_term['term_taxonomy_id']) : false;
        ...
        $this->collection_taxonomy_id = $collection_term ? intval($collection_term['term_taxonomy_id']) : false;
        ...
        $this->model_taxonomy_id = $model_term ? intval($model_term['term_taxonomy_id']) : false;
        ...
        $this->variant_taxonomy_id = $variant_term ? intval($variant_term['term_taxonomy_id']) : false;
        ...
        $this->finish_taxonomy_id = $finish_term ? intval($finish_term['term_taxonomy_id']) : false;
        ...
        $this->color_taxonomy_id = $color_term ? intval($color_term['term_taxonomy_id']) : false;
